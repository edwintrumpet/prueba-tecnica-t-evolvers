...
type Customer struct {
	...
	StartDate time.Time `json:"startDate" example:"0001-01-01T00:00:00Z" format:"iso" gorm:"column:start_date"`
	EndDate   time.Time `json:"endDate" example:"0001-01-01T00:00:00Z" format:"iso" gorm:"column:end_date"`
